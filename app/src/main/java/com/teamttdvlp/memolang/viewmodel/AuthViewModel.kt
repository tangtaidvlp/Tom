...
//import android.context.Application
...
//import com.teamttdvlp.memolang.model.sqlite.converter.entity_converter.UserConverter
...
//                             var context : Application) : BaseAndroidViewModel<AuthView>(context) {
//
//
...
//        val sharePref = context.getSharedPreferences(SIGN_IN_INFO, MODE_PRIVATE)
