...
class Language {
    ...
    companion object {
        ...
        init {
            languageMap[AFRIKAANS] = AFRIKAANS_VALUE
            languageMap[ALBANIAN] = ALBANIAN_VALUE
            languageMap[ARABIC] = ARABIC_VALUE
            languageMap[ARMENIAN] = ARMENIAN_VALUE
            languageMap[AZERBAIJANI] = AZERBAIJANI_VALUE
            languageMap[BASQUE] = BASQUE_VALUE
            languageMap[BELARUSIAN] = BELARUSIAN_VALUE
            languageMap[BENGALI] = BENGALI_VALUE
            languageMap[BULGARIAN] = BULGARIAN_VALUE
            languageMap[CATALAN] = CATALAN_VALUE
            languageMap[CHINESE] = CHINESE_VALUE
            languageMap[CROATIAN] = CROATIAN_VALUE
            languageMap[CZECH] = CZECH_VALUE
            languageMap[DANISH] = DANISH_VALUE
            languageMap[DUTCH] = DUTCH_VALUE
            languageMap[ENGLISH] = ENGLISH_VALUE
            languageMap[ESTONIAN] = ESTONIAN_VALUE
            languageMap[FILIPINO] = FILIPINO_VALUE
            languageMap[FINNISH] = FINNISH_VALUE
            languageMap[FRENCH] = FRENCH_VALUE
            languageMap[GALICIAN] = GALICIAN_VALUE
            languageMap[GEORGIAN] = GEORGIAN_VALUE
            languageMap[GERMAN] = GERMAN_VALUE
            languageMap[GREEK] = GREEK_VALUE
            languageMap[GUJARATI] = GUJARATI_VALUE
            languageMap[HAITIAN_CREOLE] = HAITIAN_CREOLE_VALUE
            languageMap[HEBREW] = HEBREW_VALUE
            languageMap[HINDI] = HINDI_VALUE
            languageMap[HUNGARIAN] = HUNGARIAN_VALUE
            languageMap[ICELANDIC] = ICELANDIC_VALUE
            languageMap[INDONESIAN] = INDONESIAN_VALUE
            languageMap[IRISH] = IRISH_VALUE
            languageMap[ITALIAN] = ITALIAN_VALUE
            languageMap[JAPANESE] = JAPANESE_VALUE
            languageMap[KANNADA] = KANNADA_VALUE
            languageMap[KOREAN] = KOREAN_VALUE
            languageMap[LATIN] = LATIN_VALUE
            languageMap[LATVIAN] = LATVIAN_VALUE
            languageMap[LITHUANIAN] = LITHUANIAN_VALUE
            languageMap[MACEDONIAN] = MACEDONIAN_VALUE
            languageMap[MALAY] = MALAY_VALUE
            languageMap[MALTESE] = MALTESE_VALUE
            languageMap[NORWEGIAN] = NORWEGIAN_VALUE
            languageMap[PERSIAN] = PERSIAN_VALUE
            languageMap[POLISH] = POLISH_VALUE
            languageMap[PORTUGUESE] = PORTUGUESE_VALUE
            languageMap[ROMANIAN] = ROMANIAN_VALUE
            languageMap[RUSSIAN] = RUSSIAN_VALUE
            languageMap[SERBIAN] = SERBIAN_VALUE
            languageMap[SLOVAK] = SLOVAK_VALUE
            languageMap[SLOVENIAN] = SLOVENIAN_VALUE
            languageMap[SPANISH] = SPANISH_VALUE
            languageMap[SWAHILI] = SWAHILI_VALUE
            languageMap[SWEDISH] = SWEDISH_VALUE
            languageMap[TAMIL] = TAMIL_VALUE
            languageMap[TELUGU] = TELUGU_VALUE
            languageMap[THAI] = THAI_VALUE
            languageMap[TURKISH] = TURKISH_VALUE
            languageMap[UKRAINIAN] = UKRAINIAN_VALUE
            languageMap[URDU] = URDU_VALUE
            languageMap[VIETNAMESE] = VIETNAMESE_VALUE
            languageMap[WELSH] = WELSH_VALUE
            languageMap[YIDDISH] = YIDDISH_VALUE
            languageMap[CHINESE_SIMPLIFIED] = CHINESE_SIMPLIFIED_VALUE
            languageMap[CHINESE_TRADITIONAL] = CHINESE_TRADITIONAL_VALUE
