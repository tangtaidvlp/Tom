...
//    @Inject set
    ...
    override fun initProperties() { dB.layoutAddFlashcard.apply {
        ...
        val languageDetail = editingCard.languagePair.split("-")
    ...
    override fun addViewEvents() { dB.apply {
        ...
        btnSave.setOnClickListener {
            layoutAddFlashcard.apply {
                ...
                this@SearchEditFlashcardActivity.viewModel.updateCard(sourceLang, targetLang, type, text, translation, using, pronunciation)
            }
        }
