...
import com.teamttdvlp.memolang.view.customview.vocabulary_info.MULTI_MEAN_EXAMPLE_MARGIN_LEFT

class OtherStructure_Text_View(context: Context, text: String) : LinearLayoutCompat(context) {
    ...
    init {
        ...
        textView.setTextColor(context.resources.getColor(R.color.dark_red))
        ...
        linearLayoutParams.leftMargin =
            MULTI_MEAN_EXAMPLE_MARGIN_LEFT
