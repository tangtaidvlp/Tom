...
class RCVRecentSearchFlashcardAdapter (var context : Context, var list : ArrayList<Flashcard> = ArrayList()) : RecyclerView.Adapter<RCVRecentSearchFlashcardAdapter.ViewHolder> () {
