...
//import android.context.Activity
...
//
//
//class AuthActivity :  BaseActivity<ActivityAuthBinding, AuthActivityViewModel>(), AuthView {
//
...
//
//    /**
//     *  Alfter Memolang is reset by some action like being overlayed by some other context (It will reload to AuthActivity)
//     *  so those function setUpSingleUserInfo can be called again (while it had been created before, context is not
...
//                setUpInfoThenNavigateToMenu(User.MockUser(it!!.id, it.recentTargetLanguage, it.recentSourceLanguage))
//            }
//        }
//    }
//
...
//
//
//    private fun resetProgressBarState() { dB.apply {
...
//        @Named("Disappear100percents") viewgroupSignInDisappear : Animator) { dB.apply {
//
...
//        @Named("Appear100percents") groupSignInWidgetsAppear : Animator) { dB.apply {
//
...
//        @Named("Waiting") delayTimeAnimator : Animator) { dB.apply {
//
